...
const encoded = dist_9([
  dist_2('2enhello world!')
]);

const decodeIterator = (chunk, next, decoder, index$$1, decoders) => {
  decoder(chunk, res => {
...
_Decoder.prototype = {
  ...
  decode(chunk) {
    return new Promise((done, fail) => {
      series(this._decoderState.receive, (next, decoder, index$$1, decoders) => { decodeIterator(chunk, next, decoder, index$$1, decoders); }, err => {
